...
const SKIP = new Set([
  ...
  'CUSTODY_ISSUER_NAME',
  'CUSTODY_FIXED_INCOME_SYNC',
  'CUSTODY_GL_BOOKING_ENABLED',
  'CUSTODY_ASSET_GL_ACCOUNT',
  'CUSTODY_CONTROL_GL_ACCOUNT',
  'CUSTODY_CASH_SYNC',
  'CUSTODY_CASH_ACCOUNT_ID',
  'ATTESTATION_ENFORCEMENT',
  'ATTESTATION_FRESH_MINUTES',
  'ATTESTATION_RUN_INTERVAL_MINUTES',
]);
