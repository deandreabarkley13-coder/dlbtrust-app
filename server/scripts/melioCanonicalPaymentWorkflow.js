 ...
 *   --makerEmail       Maker trustee email (default: $TRUST_MAKER_EMAIL or barkley420lavar@gmail.com)
...
async function main() {
  ...
  const makerEmail = args.makerEmail || process.env.TRUST_MAKER_EMAIL || 'barkley420lavar@gmail.com';
