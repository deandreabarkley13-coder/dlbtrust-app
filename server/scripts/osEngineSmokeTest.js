...
async function main() {
  ...
  const processSteps = [
    ...
    { engine: 'issuer-bridge', action: 'quote', payload: { sourceType: 'trust', sourceAccountId: '1000', amount: 0.01, asset: 'USDC', recipient: '0x69a32f285ced1dbf102c7baedf0266f1d39580a1', sourceMethod: 'manual' } },
    { engine: 'issuer-bridge', action: 'issue', payload: { sourceType: 'trust', sourceAccountId: '1000', amount: 0.01, asset: 'USDC', recipient: '0x69a32f285ced1dbf102c7baedf0266f1d39580a1', sourceMethod: 'manual' }, capture: 'issuerBridgeOperationId' },
    { engine: 'melio', action: 'status', payload: {} },
    { engine: 'melio', action: 'listVendors', payload: {} },
    { engine: 'melio', action: 'schedulePayment', payload: { amount: 0.01, sourceType: 'trust', sourceAccountId: '1000', vendor: { name: 'Smoke Test Vendor' }, deliveryMethod: 'ach' } },
    ...
    { engine: 'nickel', action: 'submitInvoice', payload: { amount: 0.01, sourceType: 'trust', sourceAccountId: '1000', vendor: { name: 'Smoke Test Vendor', bankAccount: { accountNumber: '000123456789', routingNumber: '111000025', accountType: 'checking' } }, invoiceNumber: 'SMOKE-NIC-1' }, capture: 'billPaymentId' },
    ...
    { engine: 'ptc-treasury', action: 'distribute', payload: { amount: 100, rail: 'ptc-bank', sourceType: 'trust', sourceAccountId: '1000', fromAccountId: '${ptcBankAccountId}', payee: { name: 'PTC Treasury Payee', bankName: 'Smoke Bank', routing: '111000025', account: '000123456789' }, description: 'PTC Treasury smoke distribution' } },
    { engine: 'ptc-treasury', action: 'onramp', payload: { amount: 0.01, method: 'issuer-bridge', sourceType: 'trust', sourceAccountId: '1000', asset: 'USDC', targetAddress: '0x69a32f285ced1dbf102c7baedf0266f1d39580a1', sourceMethod: 'manual' } },
