    ...
    try {
      ...
      for (const b of benList) {
        const req = await DistributionRequestEngine.createRequest({
          ...
          destinationType: b.destinationType || destinationType,
          bank: b.bank,
          biller: b.biller,
          googleWallet: b.googleWallet || (b.destinationType === 'google_wallet' || destinationType === 'google_wallet' ? { email: b.email, name: b.name, walletAddress: b.address || undefined, bank: b.bank, role: b.role } : undefined),
          payoutRail: b.payoutRail || payoutRail,
          sourceType,
          sourceAccountId,
          safeId,
          proofId: proof.id,
