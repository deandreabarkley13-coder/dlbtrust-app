    ...
    try {
      ...
      if (maker && EmailEngine) {
        ...
        await EmailEngine.sendOtp({
          ...
          otp: makerPin,
          action: 'approve',
          actionUrl: `${process.env.APP_URL || 'https://dlbtrust-app-r5oawu76jq-ue.a.run.app'}/dapp/request-approval.html?request=${request.id}&role=maker`,
        });
      }
      ...
      try {
        ...
        if (checker && EmailEngine) {
          ...
          await EmailEngine.sendOtp({
            ...
            otp: checkerPin,
            action: 'approve',
            actionUrl: `${process.env.APP_URL || 'https://dlbtrust-app-r5oawu76jq-ue.a.run.app'}/dapp/request-approval.html?request=${requestId}&role=checker`,
          });
        }
