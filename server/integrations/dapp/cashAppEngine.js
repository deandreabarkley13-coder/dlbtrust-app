...
class CashAppEngine {
   ...
   */
  static async createPayoutRequest({ amount, currency = 'USD', channel = 'ONLINE', redirectUri = `${process.env.APP_URL || 'https://dlbtrust-app-r5oawu76jq-ue.a.run.app'}/cashapp/callback`, referenceId, scopeId, accountReferenceId, note } = {}) {
