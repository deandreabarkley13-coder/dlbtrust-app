...
router.get('/status', (req, res) => {
  try {
    ...
    const checks = [
      ...
      { name: 'Trust Accounting', table: 'gl_journal_entries', query: 'SELECT COUNT(*) as c FROM gl_journal_entries' },
      { name: 'Documents', table: 'trust_documents', query: 'SELECT COUNT(*) as c FROM trust_documents' },
      { name: 'AI Agent', table: 'ai_agent_conversations', query: 'SELECT COUNT(*) as c FROM ai_agent_conversations' },
  ...
  try {
    const map = {
      engines: [
        ...
        { id: 'accounting', name: 'Trust Accounting', tables: ['gl_journal_entries', 'gl_entries', 'gl_chart_of_accounts'] },
        { id: 'documents', name: 'Documents', tables: ['trust_documents'] },
        { id: 'agent', name: 'AI Agent', tables: ['ai_agent_conversations', 'ai_agent_tasks'] },
...
router.get('/health', (req, res) => {
  try {
    ...
    const checks = [
      ...
      { name: 'GL (Accounting)', query: 'SELECT COUNT(*) as c FROM gl_journal_entries' },
      ...
      { name: 'Documents', query: 'SELECT COUNT(*) as c FROM trust_documents' },
      { name: 'AI Agent', query: 'SELECT COUNT(*) as c FROM ai_agent_conversations' },
    ];
