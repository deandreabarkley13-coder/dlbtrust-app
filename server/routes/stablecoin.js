...
const { StablecoinGateway, TreasuryEngine, BlockchainEngine, HederaEngine, MagicWalletService, Wso2ApiManager, SourceOfFundsAdapter, DEFAULT_ACCOUNT } = require('../integrations/stablecoin');
